  ...
  return (
    <>
      <section className="flex  items-center justify-between bg-white border-b border-gray-300 h-[7%] py-1 md:py-0 lg:h-[8%]  md:px-8">
        ...
        <div className="flex gap-4 max-w-[160px] md:max-w-full overflow-x-auto md:overflow-visible noScroll">
          <Link
            to={`/admin/colaboradores/horario-reporte/${id ?? ''}`}
            className="min-w-[80px] bg-gray-400 hover:bg-main transition-colors cursor-pointer text-white px-2 py-1 rounded-md "
          >
            Reporte
          </Link>
          <Link
          ...
          <span
            ...
            className={cn(
              ' bg-gray-400 hover:bg-main transition-colors cursor-pointer text-white px-2 py-1 rounded-md',
              vacaciones ? 'bg-main' : ''
            )}
          >
            Vacaciones
          ...
          <span
            ...
            className={cn(
              'min-w-[120px] bg-gray-400 line-clamp-1 hover:bg-main transition-colors cursor-pointer text-white px-2 py-1 rounded-md',
