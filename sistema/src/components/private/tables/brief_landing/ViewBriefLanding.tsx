...
export const ViewBriefLanding = (): JSX.Element => {
                    ...
                    <div className="w-full relative">
                      ...
                      {imagen1 && (
                        <img
                          ...
                          id={'img-preview1'}
                          src={`${Global.urlImages}/brief_landing/${imagen1}`}
                          alt="imagen1"
                        />
                      )}
                    </div>
                      ...
                      <div className="radio-container radio-container2 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 w-full justify-center items-center gap-8 mt-8 & > div > text-center border py-5">
                        <div className="radio-wrapper">
                          <label className="radio-button">
                            ...
                            <span className="radio-label ml-3">
                              <Link
                                to="https://plantillas.logosperu.com.pe/landing_page/1"
                                target="_blank"
                              >
                                Plantilla 1
                              </Link>
                        ...
                        <div className="radio-wrapper">
                          <label className="radio-button">
                            ...
                            <span className="radio-label ml-3">
                              <Link
                                to="https://plantillas.logosperu.com.pe/landing_page/2"
                                target="_blank"
                              >
                                Plantilla 2
                              </Link>
                        ...
                        <div className="radio-wrapper">
                          <label className="radio-button">
                            ...
                            <span className="radio-label ml-3">
                              <Link
                                to="https://plantillas.logosperu.com.pe/landing_page/3"
                                target="_blank"
                              >
                                Plantilla 3
                              </Link>
                        ...
                        <div className="radio-wrapper">
                          <label className="radio-button">
                            ...
                            <span className="radio-label ml-3">
                              <Link
                                to="https://plantillas.logosperu.com.pe/landing_page/4"
                                target="_blank"
                              >
                                Plantilla 4
                              </Link>
                        ...
                        <div className="radio-wrapper">
                          <label className="radio-button">
                            ...
                            <span className="radio-label ml-3">
                              <Link
                                to="https://plantilla.logosperu.com.pe"
                                target="_blank"
                              >
                                Plantilla 5
                              </Link>
