...
import { calendario, calendariohoy, calendarioReunion, mes, programacion, semana, sietedias } from '../../../shared/Images'
...
export const IndexCitasReuniones = (): JSX.Element => {
  ...
  return (
    <section className="w-full flex flex-col h-full">
          ...
          <div className="flex items-center w-full mt-3 bg-white shadow h-[90px] z-[2] rounded-t-md">
            <div className="flex items-center border-r border-gray-200 ">
              ...
              <button
                ...
                className="flex text-black flex-col items-center gap-1 px-2 py-1 hover:bg-gray-200  transition-colors"
              >
                <img src={calendarioReunion} alt="" className="w-[35px] object-contain" />
                <div className="flex flex-col gap-0 text-sm">
                  <span className="text-md leading-5">Nueva</span>
            ...
            <div className="flex items-center border-r border-gray-200 ">
              ...
              >
                <img src={calendariohoy} alt="" className="w-[35px] h-[32.5px] object-contain" />
              ...
              <button
                ...
                className="flex h-full text-black flex-col items-center gap-1 px-2 py-1 hover:bg-gray-200  transition-colors"
              >
                <img src={sietedias} alt="" className="w-[35px] h-[32.5px] object-contain" />
                <div className="flex h-full flex-col gap-0 text-sm">
            ...
            <div className="flex items-center border-r border-gray-200 ">
              <button
                ...
                className="flex h-full text-black flex-col items-center gap-1 px-2 py-1 hover:bg-gray-200  transition-colors"
              >
                <img src={semana} alt="" className="w-[35px] h-[32.5px] object-contain" />
                <div className="flex h-full flex-col gap-0 text-sm">
              ...
              <button
                ...
                className="flex h-full text-black flex-col items-center gap-1 px-2 py-1 hover:bg-gray-200  transition-colors"
              >
                <img src={mes} alt="" className="w-[35px] h-[32.5px] object-contain" />
                <div className="flex h-full flex-col gap-0 text-sm">
              ...
              <button
                ...
                className="flex h-full text-black flex-col items-center gap-1 px-2 py-1 hover:bg-gray-200  transition-colors"
              >
                <img src={programacion} alt="" className="w-[35px] h-[32.5px] object-contain" />
                <div className="flex h-full flex-col gap-0 text-sm">
      ...
      <ModalCita open={openCita} setOpen={setOpenCita} getUsuarios={getUsuarios} tipoInitial={tipo} usuarios={usuarios} />
      <ModalCitaView open={openView} setOpen={setOpenView} getUsuarios={getUsuarios} usuarios={usuarios} />
      <ModalCitaVistaExterna open={openVistaPrevia} setOpen={setOpenVistaPrevia} getUsuarios={getUsuarios} usuarios={usuarios} />
    </section>
  )
}
