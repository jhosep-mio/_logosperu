...
export const ListaComentarios = ({
  ...
  return (
    <div className="w-full bg-white p-2 rounded-xl h-auto max-h-[475px] overflow-y-auto">
      <h3 className="uppercase text-secondary-70 text-base w-full border-b-2 font-bold text-center pb-2 border-secondary-70 mb-6">
        Comentarios
            ...
            comentario.respuestas == 0 ? (
              ...
              >
                <div className="flex gap-2">
                  <IoCloseSharp
                    className="text-main hover:text-main_dark transition-colors text-base cursor-pointer"
                    onClick={() => {
                      setModoEdicion(false)
                      setTextoEditado('')
                      setIdComentarioAEditar(null)
                  ...
                  />
                  <FaSave className="text-main hover:text-main_dark transition-colors text-base cursor-pointer" />
                </div>
              </span>
                ) : (
                  auth.id == comentario.idUser &&
              comentario.respuestas == 0 && (
                ...
                >
                  <MdOutlineEdit className="text-main text-base hover:text-main_dark transition-colors cursor-pointer" />
                </span>
                  )
                )}
