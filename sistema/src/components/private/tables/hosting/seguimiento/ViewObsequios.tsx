...
import { type arrayCorreos, type arrayImagenes, type comentariosValues, type avanceValues } from '../../../../shared/schemas/Interfaces'
import useAuth from '../../../../../hooks/useAuth'
import axios from 'axios'
import { Global } from '../../../../../helper/Global'
import Swal from 'sweetalert2'
import { cn } from '../../../../shared/cn'
import { ViewSwiperCorreos } from '../../servicios/ViewSwiperCorreos'
import { Loading } from '../../../../shared/Loading'
import { AnimatePresence, motion } from 'framer-motion'
import { AgregarCorreos } from '../../servicios/AgregarCorreos'
import { SwiperCorreos } from '../../servicios/SwiperCorreos'
              ...
              arrayArchivos.comprobante && (
                <section className="px-6 mt-10 w-[300px]">
                  ...
                  <a target='_blank' href={// @ts-expect-error
                    `https://api.logosperu.com.pe/public/comprobantesHosting/${arrayArchivos.comprobante.archivoName ?? ''}`} className="relative group cursor-pointer" rel="noreferrer" >
                         <img
                        src={pdf}
