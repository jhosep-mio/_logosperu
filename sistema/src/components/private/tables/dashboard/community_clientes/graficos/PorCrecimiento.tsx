    ...
    <>
      <div className="flex justify-between px-4">
        <h1 className="w-full text-left text-gray-600 font-semibold text-xl line-clamp-1">
          Cantidad de proyectos CM por fechas
        </h1>
        <div className="w-full flex gap-4 justify-end">
          <button
            type="button"
            onClick={() => {
              setOpen({ estado: true, fecha: null })
            }}
            className="bg-green-600 hover:bg-green-700 transition-colors px-3 text-white rounded-md"
          >
            Ver todos
          </button>
          <MdOutlineZoomOutMap
