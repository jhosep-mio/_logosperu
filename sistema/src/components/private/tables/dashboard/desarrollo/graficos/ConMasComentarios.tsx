    ...
    datasets: [
      {
        ...
        backgroundColor: [
          ...
          'rgba(255, 159, 64, 0.5)',
          'rgba(255, 69, 0, 0.5)', // Naranja oscuro
          'rgba(0, 128, 0, 0.5)', // Verde oscuro
          'rgba(128, 0, 128, 0.5)', // Púrpura oscuro
          'rgba(255, 140, 0, 0.5)', // Naranja oscuro
          'rgba(218, 112, 214, 0.5)', // Orquídea oscura
          'rgba(70, 130, 180, 0.5)', // Azul acero claro
          'rgba(176, 196, 222, 0.5)' // Azul acero claro
        ],
        borderColor: [
          'rgba(255, 99, 132, 1)',
          'rgba(54, 162, 235, 1)',
          ...
          'rgba(218, 112, 214, 1)', // Orquídea oscura
          'rgba(70, 130, 180, 1)', // Azul acero claro
          'rgba(176, 196, 222, 1)' // Azul acero claro
        ],
        borderWidth: 1
      }
    ]
