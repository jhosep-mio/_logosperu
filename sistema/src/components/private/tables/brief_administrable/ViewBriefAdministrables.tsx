...
export const ViewBriefAdministrables = (): JSX.Element => {
  ...
  const getFlyer = async (): Promise<void> => {
    const request = await axios.get(
      `${Global.url}/oneBriefAdministrables/${id ?? ''}`,
      {
        headers: {
                    ...
                    <div className="w-full relative">
                      ...
                      {imagen1 && (
                        <img
                          ...
                          id={'img-preview1'}
                          src={`${Global.urlImages}/brief_administrables/${imagen1}`}
                          alt="imagen1"
                        />
                      )}
                    </div>
                    ...
                    <div className="w-full relative">
                      <p
                        className="bg-white pt-0 pr-2 pb-0 lg:pl-2 -mt-3 mr-0 mb-0 ml-1 lg:ml-2 font-medium text-gray-600
                                            lg:absolute"
                      >
                        7. ¿Qué internas de las elegidas en la pregunta anterior
                        desea administrar? (Podrá modificar, eliminar y añadir
                        el contenido de las internas).
                      </p>
                      <textarea
                        className="border placeholder-gray-400 focus:outline-none
                                            focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
