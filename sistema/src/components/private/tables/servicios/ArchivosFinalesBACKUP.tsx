      ...
      <div className="flex flex-row gap-0 justify-between lg:gap-2 mb-2 ">
        <div className="flex flex-col gap-3 mb-2">
          ...
          className="text-base items-center gap-2 lg:text-2xl font-bold text-black flex hover:underline cursor-pointer py-0 rounded-md transition-colors">
            <GoFileDirectoryFill className='text-black text-md mt-1'/> <span>Archivos</span> <span className='lowercase first-letter:uppercase inline-block'>{datos?.nombre_marca ? datos?.nombre_marca : ''}</span>
          </div>
          {!openFolder &&
        ...
        {!openFolder &&
            ...
            <AnimatePresence>
                ...
                >
                    {plan && (plan?.tipo?.includes('Diseño Logotipo') || (plan?.nombre.includes('MANUAL DE MARCA')) || (plan?.nombre.includes('BROCHURE'))) && (
