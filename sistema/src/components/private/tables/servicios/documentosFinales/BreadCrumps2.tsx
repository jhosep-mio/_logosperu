...
export const BreadCrumps2 = ({ currentPath, setCurrentPath, marca }: { currentPath: Folder[] | null, setCurrentPath: Dispatch<SetStateAction<Folder[] | null>>, marca: string }): JSX.Element => {
