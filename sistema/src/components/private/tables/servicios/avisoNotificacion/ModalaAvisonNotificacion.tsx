...
export const ModalaAvisonNotificacion = ({
  ...
  React.useEffect(() => {
    ...
    setContexto(`<p>Por el presente debemos informarle sobre el aviso de notificación (adjuntado)</p><p>El cual el área Administrativa Remite hacia su persona.</p><p><br></p><p>En el presente</p><p>Según lo acordado con Área Diseño, Área Desarrollo, Área administrativa y Gerencia llegado a la fecha limite:</p><p>SE DARA POR CONCLUIDO EL PROYECTO <strong style="background-color: yellow;">${datos.nombre_marca ?? ''}</strong><strong> </strong></p><p><br></p>`)
  }, [])
