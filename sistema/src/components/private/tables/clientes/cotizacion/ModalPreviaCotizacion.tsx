...
export const ModalPreviaCotizacion = ({
  open,
  datos,
  planes,
  setOpen
  ...
  const generarCodigo = async (plan: string, nombre: string): Promise<void> => {
    ...
    try {
      ...
      if (request.data.status == 'success') {
        ...
        let precio = 0
        if (
          formatearContrato(plan) == 'LPDOMINIO' ||
            formatearContrato(plan) == 'LPHOST400MB' ||
            formatearContrato(plan) == 'LPHOST1000MB' ||
            formatearContrato(plan) == 'LPHOST3000MB' ||
            formatearContrato(plan) == 'LPHOST10000MB' ||
            formatearContrato(plan) == 'LPHOST10000MBCP' ||
            formatearContrato(plan) == 'LPHOSTILIM' ||
            formatearContrato(plan) == 'LPHOSTILIMCP'
        ) {
          descripcionPago =
              '<ul><li><strong style="color: red;"> 70%&nbsp;</strong><strong>&nbsp;</strong>A la aceptación del presente contrato</li><li><strong> 30%&nbsp; a la aprobación del proyecto&nbsp;</strong></li></ul>'
        } else if (formatearContrato(plan) == 'LPMGDOM' || formatearContrato(plan) == 'LPSID') {
          descripcionPago =
              '<ul><li><strong style="color: red;"> 70%&nbsp;</strong><strong>&nbsp;</strong>A la aceptación del presente contrato</li><li><strong> 30%&nbsp; a la aprobación del proyecto&nbsp;</strong></li></ul>'
        } else if (
          formatearContrato(plan) == 'LPACTW' ||
            formatearContrato(plan) == 'LPACTWE' ||
            formatearContrato(plan) == 'LPCPPB' ||
            formatearContrato(plan) == 'LPCPPM' ||
            formatearContrato(plan) == 'LPIPP'
        ) {
          descripcionPago =
              '<ul><li><strong style="color: red;"> 70%&nbsp;</strong><strong>&nbsp;</strong>A la aceptación del presente contrato</li><li><strong> 30%&nbsp; a la aprobación del proyecto&nbsp;</strong></li></ul>'
        } else {
        ...
        if (formatearContrato(plan) == 'LP69') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan).includes('LP69')) {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPEXC') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan).includes('LPEXC')) {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPPG') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPCME') {
          descripcionEntrada =
              '<p><strong>PLAN EMPRENDEDOR</strong></p><p><br></p><p>✓ Análisis&nbsp;de Marketing Digital</p><p>✓ 02 PUBLICACIONES POR SEMANA (LUNES A SABADO)&nbsp;</p><ul><li>&nbsp;&nbsp;Dividido :&nbsp;01 DISEÑO DE FLYER O POST / 01 DESARROLLO DE REEL Max 10 segundos (EFECTOS Y MUSICALIZACIÓN - SIN LOCUCIÓN EN OFF) - Entregable Cronograma&nbsp;</li></ul><p>✓ 01 DISEÑO DE PORTADA y Perfil Facebook - WSP Bussines x MES</p><p>✓ Asesoría en creación de redes (Facebook - Instagram - TIKTOK)&nbsp;</p><p>✓ CONTRATO MINIMO X 90 días&nbsp;</p>'
        } else if (formatearContrato(plan) == 'LPCMC') {
          descripcionEntrada =
              '<p><strong>&nbsp;PLAN COBRE&nbsp;</strong></p><p><br></p><p>✓ Análisis&nbsp;de Marketing Digital</p><p>✓ 01 PUBLICACIONES POR SEMANA (LUNES A SABADO)&nbsp;</p><p>&nbsp;&nbsp;Dividido :&nbsp;01 DISEÑO DE FLYER O POST&nbsp;&nbsp;</p><p>✓ 02 DESARROLLO DE REEL Max 10 segundos x MES (EFECTOS Y MUSICALIZACIÓN - SIN LOCUCIÓN EN OFF) - Entregable Cronograma&nbsp;</p><p>✓ 01 DISEÑO DE PORTADA y Perfil Facebook - WSP Bussines x MES</p><p>✓ Asesoría en creación de redes (Facebook - Instagram - TIKTOK)&nbsp;</p><p>✓ CONTRATO MINIMO X 90 días</p>'
        } else if (formatearContrato(plan) == 'LPCMS') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPCMG') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPBRO6') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPBRO4') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPBRO8') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPTV') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPREEL') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPFLYER') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPSEO') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPADS') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPWAE') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPWAG') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPW') {
          precio = 499
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPMAPS') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPHOST') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPLANDING-ADM') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPLANDING-TV') {
          descripcionEntrada =
          ...
          formatearContrato(plan) == 'LPB' ||
            formatearContrato(plan) == 'LPBAM' ||
            formatearContrato(plan) == 'LPBAM2'
        ) {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPHOST400MB') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPHOST1000MB') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPHOST3000MB') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPHOST10000MB') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPHOSTILIM') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPHOSTILIMCP') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPDOMINIO') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPMANUALC') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPMANUALS') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPADSE') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPADSI') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPADSF') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPFADSE') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPFADSI') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPFADSF') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPAREDESB') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPAREDESA') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPTVE') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPTVS') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPTVG') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPCONC') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPACTW') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPACTWE') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPCPPB') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPCPPM') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPIPP') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPMGDOM') {
          descripcionEntrada =
        ...
        } else if (formatearContrato(plan) == 'LPSID') {
          descripcionEntrada =
  ...
  return (
      <>
        <Dialog
          ...
          className="w-screen p-0 m-0 modal_dialog_correlativo dialog_index"
        >
          <section
            className={`grid ${
          ...
          >
            {values.id_contrato ? (
              ...
              <div className="w-full">
                <h2 className="text-center text-main_dark w-full pt-5 text-3xl font-bold">
                  {'CREAR COTIZACIÓN'}
                </h2>
                <DialogContent
                  className={cn(
                    'w-full max-h-[500px] p-0',
                    abrirPlan ? 'md:w-[850px]' : 'md:w-[850px]'
                  )}
                >
                  <DialogContentText
                    ...
                    {loadingValidacion ? (
                      ...
                      >
                        <section className='grid grid-cols-2 gap-5 justify-between'>
                            ...
                            <div className="w-full lg:relative mt-2 col-span-2">
                                ...
                                {filterDate().map((plan) => (
                                    ...
                                    onClick={() => {
                                      generarCodigo(plan.codigo, plan.nombre)
                                    }}
                                    >
                                    {plan.nombre}
                                    </p>
                        ...
                        <div className="flex w-full justify-center gap-3 rounded-md text-black mt-5">
                          <Link
                            to="#"
