...
export const ListadoClientesSInProyectos = (): JSX.Element => {
  ...
  const exportExcel = (): void => {
    ...
    window.open('/admin/lista-preventa/sinproyectos/status', '_blank')
  }
    ...
    <>
      <div className="flex flex-col md:flex-row items-center justify-between gap-y-4 mb-3 md:mb-5 gap-2">
        ...
        <div className="w-fit md:w-fit flex flex-row items-center gap-4">
            <RiFileExcel2Fill className="text-green-700 text-2xl md:text-3xl cursor-pointer" onClick={() => { exportExcel() }}/>
        </div>
      </div>
      {loading
        ? <Loading />
                    ...
                    <div className="md:text-center md:flex md:justify-center items-center absolute md:relative right-0 top-0">
                      ...
                      >
                        <MenuItem className="p-0 hover:bg-transparent">
                          <Link
                            to={`/admin/lista-clientes/ver/${orden.id}`}
