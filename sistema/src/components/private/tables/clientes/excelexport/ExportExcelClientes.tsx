...
export const ExportExcelClientes = (): JSX.Element => {
  ...
  let filteredProductos: ValuesPreventaModificate[] = productos
  ...
  return (
    <>
        <Table
            id="productos2"
            className=" align-middle table-hover display w-full text-black "
        ...
        >
            ...
            <tbody id="tableBody">
            <>
                {filteredProductos.map((clinica, index) => {
                  return (
                    <tr
                        key={clinica.id}
