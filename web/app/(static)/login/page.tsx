...
export const metadata = {
  title: 'Inicia sesión - Logos Perú',
  description:
  ...
  alternate: {
    canonical: 'https://logosperu.com.pe/login'
  },
...
export default function Login () {
  return (
    <>
      ...
      <section className="w-full pt-[171px] pb-20 bg-[#001734] degraded_main  flex justify-center">
        <FormLogin />
      </section>
      <Footer />
    </>
