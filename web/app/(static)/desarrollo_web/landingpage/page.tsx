...
export const metadata = {
  title: 'Diseño de Landingpage - Logos Perú',
  description:
    'Creamos landing pages optimizadas para convertir visitas en clientes. Atraiga y capte la atención de su audiencia en Perú con un diseño estratégico y efectivo que impulsa sus campañas y promociona sus servicios o productos.',
  msvalidate: 'A01D8EBEAA551809606CCFFE234E6DF5',
  alternate: {
    canonical: 'https://logosperu.com.pe/desarrollo_web/landingpage'
  },
  ...
  openGraph: {
    ...
    description:
      'Creamos landing pages optimizadas para convertir visitas en clientes. Atraiga y capte la atención de su audiencia en Perú con un diseño estratégico y efectivo que impulsa sus campañas y promociona sus servicios o productos.',
    url: 'https://logosperu.com.pe/desarrollo_web/landingpage',
...
export default function LandingPage () {
  ...
  return (
    <>
      <Header />
      <IconTop />
      <section className="w-full h-screen bg-servicios bg-servicios-landingpage">
        ...
        <div className="max-w-[1450px] h-full px-4 pt-[10px] mx-auto relative w-full flex flex-col justify-center items-center">
          ...
          <p className="text-gray-100 font_Archivo max-w-[650px] mx-auto text-center mt-4 text-base md:text-xl">
            Creamos páginas de aterrizaje visualmente impactantes y enfocadas en
            resultados, ideales para destacar tus productos, servicios u ofertas
            especiales y maximizar el impacto de tu campaña.
          </p>
          <a
            href="#planes"
        ...
        <ContentInternas className="flex flex-col lg:flex-row gap-5 py-20">
          <div className="w-full lg:w-1/2 circulo_difuminado pl-0 sm:pl-4 md:pl-8 lg:pl-12 pr-9 sm:pr-8 md:pr-12 lg:pr-20">
            <div className="w-full flex flex-col">
              <Connect
                ...
                imagen2="/assets/images/servicios/desarrollo_web/icons/formulario.png"
                imagen3="/assets/images/servicios/desarrollo_web/icons/correos.png"
                titulo1="Responsive Design"
                titulo2="Formulario de contacto"
                titulo3="Correos corporativos"
              />
            </div>
          </div>
          <div className="w-full lg:w-1/2">
            ...
            <h2 className="font_allRound text-3xl md:text-4xl text-white mb-6">
              Atrae y Convierte Clientes con una
              <span className="text-main"> Landing Page Irresistible</span>
            </h2>
            <p className="mt-4 text-base md:text-lg text-white font_Archivo">
              Captura la atención de tus visitantes desde el primer momento con
              una landing page optimizada y diseñada para convertir. Solicita tu
              landing page hoy mismo y logra resultados con una estrategia
              digital efectiva y persuasiva.
      ...
      <section
        className="bg-white relative z-10 before:absolute before:w-full before:h-full before:top-0 before:left-0 before:bg-[url(/assets/svg/fondo_diseno.svg)] before:opacity-30 before:-z-10"
        id="planes"
      >
        <ContentInternas className="py-20 pt-36">
          ...
          <SwiperPlanes planes={planesWebLanding} />
        </ContentInternas>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <Link
          href={'/portafolio/desarrollo_web/rda'}
        ...
        >
          ...
          <div className="w-full absolute top-0 left-0 h-full flex items-center justify-center">
            <img
              src="/assets/images/portafolio/desarrollo_web/rda/logo.webp"
              alt=""
        ...
        >
          <img
            src="/assets/images/portafolio/desarrollo_web/inacons/fondo2.webp"
            alt=""
            className="flex object-cover h-full w-full group-hover:scale-110 transition-all"
          />
          <div className="w-full absolute top-0 left-0 h-full flex items-center justify-center">
            <img
              src="/assets/images/portafolio/desarrollo_web/inacons/logo.webp"
              alt=""
              className="w-[250px] block drop-shadow-xl group-hover:drop-shadow-2xl transition-all"
            />
          </div>
        ...
        >
          <img
            src="/assets/images/portafolio/desarrollo_web/agua_kungu/fondo2.webp"
            alt=""
            className="flex object-cover h-full w-full group-hover:scale-110 transition-all"
          />
          <div className="w-full absolute top-0 left-0 h-full flex items-center justify-center">
            <img
              src="https://logosperu.com.pe/assets/images/portafolio/desarrollo_web/agua_kungu/logo.webp"
              alt=""
              className="w-[250px] block drop-shadow-xl group-hover:drop-shadow-2xl transition-all"
            />
          </div>
