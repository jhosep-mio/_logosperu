...
import { FilterTerminos } from '@/public/components/web/terminologia/FilterTerminos'
export const metadata = {
  title: 'Terminologías - Logos Perú',
  description:
  ...
  twitter: {
    ...
    description:
      'Creamos diseño de Logotipos creativos y profesionales para su empresa o negocio en Perú, diferénciate, brindamos la mejor propuesta de diseño de logo que mostrará la identidad corporativa de su marca.',
    creator: '@DLogosPeru',
    image: 'https://logosperu.com/public/img/seo/PORTADA_WEB_DISEÑO_LOGOTIPO.png'
  }
}
export default function page () {
  return (
    <>
      <Header />
      <div className="fondoTerminologia bg-white pt-[5rem] lg:pt-[15vh]">
        <FilterTerminos />
      </div>
      <Footer />
    </>
