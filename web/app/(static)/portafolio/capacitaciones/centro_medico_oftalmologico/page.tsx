  ...
  return (
    <section className="relative z-10  bannerMain bg-white font_Archivo">
      ...
      <div className="h-auto w-full relative">
        <img
          src="/assets/images/portafolio/capacitaciones/centro_medico_oftalmologico/fondo.webp"
          alt=""
          className="absolute inset-0 w-full h-full object-left lg:object-center object-cover z-[-1]"
        />
        <div className="pt-[9vh] relative overflow-hidden lg:pt-[10vh] lg:h-fit p-4 lg:pb-0 lg:px-20 xl:px-28 2xl:px-36 ">
          <div className="w-full flex justify-center text-white ">
            <div className="flex gap-2 items-center text-white">
              <span className="uppercase font-bold text-xl hidden lg:block lg:text-[3vh] text-white text_shadow2">
                CLIENTE
              </span>
              ...
              <h1 className="uppercase text_shadow font-bold text-white mt-4 lg:mt-0 flex gap-1 lg:gap-0 lg:flex-col text-lg lg:text-[2.4vh] leading-7 text-center">
                CENTRO MÉDICO <span className=""> OFTALMOLÓGICO</span>
              </h1>
            </div>
          </div>
          <Gatito/>
          ...
          <div className="w-full py-[3vh] lg:py-[10vh]">
            <ImageLogo image="capacitaciones/centro_medico_oftalmologico/logo.webp" />
          </div>
          <Subtitle texto="Salud Visual en Facebook Ads" />
        </div>
      </div>
      ...
      <div className="w-full flex-col bg-white font_Archivo_bold">
        <div className="flex flex-col lg:flex-row gap-4 2xl:gap-10 py-4 lg:pt-0 2xl:pb-8">
          <div className="w-full lg:w-[40%] 2xl:w-1/2 h-full xl:pr-10 xl:pl-24 xl:py-16 m-auto">
            <img
              src="/assets/images/portafolio/capacitaciones/centro_medico_oftalmologico/logo2.webp"
              alt=""
              className="w-[80%]   block m-auto h-full object-contain "
            />
          </div>
          <div className="w-full lg:w-[60%] 2xl:w-1/2  text-white bg-[#05B5AB] rounded-l-full flex items-center justify-center">
        ...
        <div className="w-full z-[2] relative font_Archivo_bold">
          <h3 className="text-[#018CCF] text-lg lg:text-3xl text-center w-[90%] mx-auto pt-4 pb-4 lg:pb-8">
            La capacidad de gestionar y optimizar internamente sus campañas de
            Facebook Ads permitió al centro mantener una presencia constante y
            efectiva en las redes sociales
          </h3>
          <div className="flex flex-col lg:flex-row-reverse justify-center relative py-4 px-4 lg:pt-0 lg:pb-8 ">
            <div className="w-full lg:w-1/2 h-full">
              <img
                src="/assets/images/portafolio/capacitaciones/centro_medico_oftalmologico/capturareunion.webp"
                alt=""
            ...
            <div className="w-full lg:w-[50%] 2xl:w-[40%] flex h-full flex-col my-auto">
              <div className="w-full h-[50%] text-white bg-[#018CCF] rounded-b-full lg:rounded-br-none lg:rounded-l-full flex items-center justify-center">
        ...
        <div className="w-full flex flex-col p-4 lg:p-10 relative z-[2] bg-[#05B5AB] lg:bg-transparent">
          <img
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-10 required: z-[2] w-full lg:w-[80%] mx-auto py-6 lg:py-32">
            <div className="w-full lg:w-[50%]">
              <video controls className="w-full object-contain">
                <source
                  src="/assets/images/portafolio/capacitaciones/centro_medico_oftalmologico/facebook.mp4"
                  type="video/mp4"
            ...
            <div className="w-full lg:w-1/2">
              <div className="w-[90%] h-full mx-auto flex flex-col justify-center gap-3 lg:gap-10 text-white font_Archivo_bold">
                ...
                <div className="w-full flex flex-col gap-2 lg:gap-6">
                  <p className="text-lg lg:text-2xl w-full text-[#05B5AB] lg:text-white bg-white lg:bg-[#05B5AB] py-4 px-4 text-center rounded-xl">
                    Fundamentos de Facebook Ads
                  </p>
                  <p className="text-lg lg:text-2xl w-full text-[#05B5AB] lg:text-white bg-white lg:bg-[#05B5AB] py-4 px-4 text-center rounded-xl">
        ...
        {/* <div className="w-full flex flex-col p-4 lg:p-10 relative z-[2]">
          <img
            src="/assets/images/portafolio/capacitaciones/centro_medico_oftalmologico/fondo3.webp"
            alt=""
            className="absolute w-full inset-0 left-0 top-0 right-0 z-0"
          />
          <div className="flex gap-10 required: z-[2] w-[80%] mx-auto py-32">
            <div className="w-[50%]">
              <img
                src="/assets/images/portafolio/capacitaciones/centro_medico_oftalmologico/video.webp"
                alt=""
                className="w-full object-contain"
              />
            </div>
            <div className="w-1/2">
              <div className="w-[90%] h-full mx-auto flex flex-col justify-center gap-10 text-white font_Archivo_bold">
                <h3 className="text-5xl text-center w-full uppercase">
                  ¿QUÉ INCLUYÓ LA <br /> CAPACITACIÓN?
                </h3>
                <div className="w-full flex flex-col gap-6">
                  <p className="text-2xl w-full bg-[#05B5AB] py-4 px-4 text-center rounded-xl">
                    Fundamentos de Facebook Ads
                  </p>
                  <p className="text-2xl w-full bg-[#05B5AB] py-4 px-4 text-center rounded-xl">
                    Segmentación de Audiencias
        ...
        <div className="w-full h-full relative -mt-[18%] md:-mt-[5%]  lg:-mt-[3%] z-10 overflow-hidden">
          <img
          ...
          <div className="w-full h-full absolute inset-0 flex flex-col gap-3 2xl:gap-6 items-center px-4 lg:px-10 mt-[20%] md:mt-[10%] text-white">
            ...
            <img
              src="/assets/images/portafolio/capacitaciones/centro_medico_oftalmologico/certificado.webp"
              alt=""
      ...
      <ButtonPlanes parametro= 'capacitacion facebook'/>
    </section>
  )
}
