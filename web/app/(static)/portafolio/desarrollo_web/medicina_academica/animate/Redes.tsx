      ...
      <div className="w-full h-full absolute py-12 md:py-0 inset-0 flex flex-col justify-center items-center z-[2]">
        ...
        <div className="flex justify-center items-center w-full my-4 gap-4">
          <motion.a
            ...
            transition={{ duration: 0.3 }}
            href="https://www.facebook.com/medicinacademica"
            target="_blank"
            className={
          ...
          <motion.a
            ...
            href="https://www.instagram.com/medicinacademica/"
            target="_blank"
            className={
          ...
          <motion.a
            ...
            href="https://api.whatsapp.com/send/?phone=https://wa.me/message/57RIV2SU5XLKK1"
            target="_blank"
            className={
