    ...
    <section className="relative z-10  bannerMain degraded_main font_Archivo">
      ...
      <div className="h-auto w-full relative">
        ...
        <div className="pt-[9vh] relative overflow-hidden lg:pt-[10vh] lg:h-fit p-4 lg:pb-0 lg:px-20 xl:px-28 2xl:px-36 ">
          <div className="w-full flex justify-center text-[#000130] ">
            <div className="flex gap-2 items-center text-[#000130]">
              <span className="uppercase font-bold text-xl hidden lg:block lg:text-[3vh] text-[#000130] text_shadow">
                CLIENTE
              </span>
              <AiOutlineCaretRight className="text-4xl hidden lg:block text-[#F4D35F]" />
              <h1 className="uppercase text_shadow font-bold text-[#000130] mt-4 lg:mt-0 flex gap-1 lg:gap-0 lg:flex-col text-lg lg:text-[2.4vh] leading-7 text-center">
                INACONS
              </h1>
            </div>
          </div>
          ...
          <div className="w-full py-[3vh] lg:py-[10vh]">
            <ImageLogo image="desarrollo_web/inacons/logo.webp" />
          </div>
          <Subtitle texto="EXCELENCIA EN INGENIERÍA" />
        </div>
      </div>
      ...
      <div className="flex flex-col w-full relative overflow-hidden bg-white  h-auto">
        <img
          src="/assets/images/portafolio/desarrollo_web/inacons/fondo_2.webp"
          alt=""
        ...
        <div className="w-full relative py-16">
          <img
            src="/assets/images/portafolio/desarrollo_web/inacons/fondo.webp"
            alt=""
            ...
            <div className="w-[97%] h-[97%] rounded-[50px]">
              <div className="rounded-[50px] absolute left-0 top-0 w-full h-full pt-[39px] lg:pt-[55px] pl-[13.1px] lg:pl-[19px] pr-[66px] lg:pr-[41px] pb-[10px] lg:pb-[18px]">
                <div className="w-full h-full rounded-bl-[29px] rounded-br-[29px] lg:rounded-bl-[34px] lg:rounded-br-[34px] overflow-auto scroll_black">
                  <img
                    src="/assets/images/portafolio/desarrollo_web/inacons/capturacel.webp"
                    alt="Screen Capture"
      ...
      <div className="w-full h-[200px] md:h-[300px] lg:h-auto relative">
        <img
          src="/assets/images/portafolio/desarrollo_web/inacons/recurso4.webp"
          alt=""
      ...
      <div className="w-full flex flex-col p-4 py-10 lg:p-10 relative z-2 font_Archivo_bold">
        <img
          src="/assets/images/portafolio/desarrollo_web/inacons/fondo5.webp"
          alt=""
        ...
        <img
          src="/assets/images/portafolio/desarrollo_web/inacons/captura_sistema.webp"
          alt=""
      ...
      <div className="w-full h-[140px]  lg:h-[300px] flex flex-col justify-center items-center text-gray-300 relative cursor-pointer degraded_main z-1">
        <img
          src="/assets/images/portafolio/desarrollo_web/inacons/foot_1.webp"
          alt=""
