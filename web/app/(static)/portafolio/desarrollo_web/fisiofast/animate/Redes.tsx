  ...
  return (
    <>
      ...
      <div className="w-full h-full absolute py-12 md:py-0 inset-0 flex flex-col justify-center items-center z-[2]">
        ...
        >
          Excelencia y <br /> Rehabilitación
        </motion.h2>
        <div className="flex justify-center items-center w-full my-4 gap-4">
          <motion.a
            ...
            transition={{ duration: 0.3 }}
            href="https://www.facebook.com/fisioterapiasespecializadas?locale=es_LA"
            target="_blank"
            className={
          ...
          <motion.a
            ...
            href="https://www.instagram.com/fisiofast_medic/"
            target="_blank"
            className={
