  ...
  return (
    <>
      <motion.img
        ...
        src="/assets/images/portafolio/desarrollo_web/fisiofast/recurso3.webp"
        alt=""
      ...
      <div className="justify-center flex flex-col gap-5 overflow-hidden items-center lg:pl-16 z-[2] ">
        ...
        >
          Una característica clave de la página web es la funcionalidad de reservas de citas en línea, que facilita a los pacientes la gestión de sus consultas y tratamientos. Gracias a nuestra experiencia en posicionamiento web y estrategias de SEO, Fisiofast Medic ha alcanzado el primer lugar en las búsquedas de Google.
        </motion.p>
        <motion.p
          initial={{ opacity: 0, transform: 'translateX(50%)' }}
          whileInView={{ opacity: 1, transform: 'translateX(0%)' }}
        ...
        >
          FISIOFAST MEDIC OCUPA EL 1ER LUGAR EN BÚSQUEDA DE GOOGLE
        </motion.p>
      </div>
    </>
  )
