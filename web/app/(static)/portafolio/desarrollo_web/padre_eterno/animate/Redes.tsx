    ...
    <>
      ...
      <div className="w-full h-full absolute py-12 md:py-0 inset-0 flex flex-col justify-center items-center z-[2]">
        <motion.h2
          ...
          className="text-white text_shadow text-[4rem] md:text-[7vh] lg:text-[10vh] font_Atlatis"
        >
          Dilo con flores
        </motion.h2>
        <div className="flex justify-center items-center w-full my-4 gap-4">
          <motion.a
            ...
            transition={{ duration: 0.3 }}
            href="https://www.facebook.com/FloreriaPadreEterno/"
            target="_blank"
            className={
          ...
          <motion.a
            ...
            href="https://www.instagram.com/floreriapadreeterno/?igshid=ZDc4ODBmNjlmNQ%3D%3D"
            target="_blank"
            className={
          ...
          <motion.a
            ...
            href="https://api.whatsapp.com/send/?phone=+51994181726"
            target="_blank"
            className={
              'flex items-center group justify-center  rounded-full p-2 transition-colors bg-white hover:bg-[#25d366]'
            }
            rel="noreferrer"
          >
