  ...
  return (
    <>
      <motion.img
        ...
        src="/assets/images/portafolio/desarrollo_web/agua_kungu/recurso3.webp"
        alt=""
      ...
      <div className="justify-center flex flex-col gap-5 overflow-hidden items-center lg:pl-16 z-[2] ">
        ...
        >
          En nuestra página web, los usuarios pueden visualizar nuestros
          productos y enviar un mensaje solicitando una cotización. Esta
          funcionalidad refleja nuestro compromiso con la accesibilidad y la
          atención personalizada hacia nuestros clientes. Ademas, ha logrado
          ocupar el primer lugar en las búsquedas relacionadas con agua
          purificada
        </motion.p>
        <motion.p
          initial={{ opacity: 0, transform: 'translateX(50%)' }}
        ...
        >
          AGUA KUNGU OCUPA EL 1ER LUGAR EN BÚSQUEDA DE GOOGLE
        </motion.p>
      </div>
    </>
  )
