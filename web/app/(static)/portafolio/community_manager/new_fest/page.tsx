  ...
  return (
    <section className="relative z-10  bannerMain degraded_main font_Archivo">
      ...
      <div className="h-auto w-full relative">
        <img
          src="/assets/images/portafolio/community_manager/new_fest/fondo.webp"
          alt=""
        ...
        <div className="pt-[9vh] relative overflow-hidden lg:pt-[10vh] lg:h-fit p-4 lg:pb-0 lg:px-20 xl:px-28 2xl:px-36 ">
          ...
          <div className="w-full py-[3vh] lg:py-[6vh]">
            <ImageLogo image="community_manager/new_fest/logo.webp" />
          </div>
          <Subtitle texto=" Creando Experiencias Inolvidables" />
        </div>
      </div>

      <div className="w-full lg:h-fit xl:h-auto relative bg-white overflow-hidden ">
        <ImageMarca />
        <img
          src="/assets/images/portafolio/community_manager/new_fest/fondo5.webp"
          alt=""
          ...
          <div className="w-full h-auto relative lg:py-10 xl:py-24 px-4 flex-col lg:flex-row lg:px-10 flex gap-10 max-w-[2000px] mx-auto">
                  ...
                  <div className="w-[97%] h-[97%] rounded-[50px]">
                    <div className="rounded-[50px] absolute left-0 top-0 w-full h-full pt-[39px] lg:pt-[55px] pl-[13.1px] lg:pl-[19px] pr-[66px] lg:pr-[41px] pb-[10px] lg:pb-[18px]">
                      <div className="w-full h-full rounded-bl-[29px] rounded-br-[29px] lg:rounded-bl-[34px] lg:rounded-br-[34px] overflow-auto scroll_black">
                        <img
                          src="/assets/images/portafolio/community_manager/new_fest/celular.webp"
                          alt="Screen Capture"
            ...
            <div className="flex flex-col justify-center w-full xl:w-[60%]">
              ...
              <div className="flex flex-wrap xl:flex-nowrap flex-row w-full justify-between gap-x-0 gap-y-3 xl:gap-10 mt-10">
                <Link
                  href="https://www.facebook.com/newfest.pe"
                  className="w-[49%] xl:w-full flex bg-[#DD6A13] py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
                ...
                <Link
                  href="https://www.instagram.com/newfest.peru/"
                  className=" w-[49%] xl:w-full  flex bg-[#DD9F00] py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
      ...
      <div className="w-full relative z-2 bg-black">
        <img
          src="/assets/images/portafolio/community_manager/new_fest/fondo3.webp"
          alt=""
        ...
        <div className="w-full flex flex-col justify-center lg:flex-row items-center gap-3 lg:gap-10 px-4 lg:px-10 z-1  max-w-[2000px] mx-auto absolute inset-0 top-0  z-[0]">
          <img
            src="/assets/images/portafolio/community_manager/new_fest/recurso3.webp"
            alt=""
          ...
          <div className="h-fit lg:h-full w-full xl:w-[30%] flex flex-col items-center justify-center text-[#001D3F] font_Archivo_bold gap-3 lg:gap-5 xl:gap-10 text-center text-base text-[1.25rem] xl:text-[1.5rem]">
            <p className="">
              NEW FEST VISUALIZA EL PROCESO DE LOS POST EN NUESTRO SISTEMA
      ...
      <div className="w-full relative z-2 mt-[-30%] lg:mt-[-10%]">
        <img
          src="/assets/images/portafolio/community_manager/new_fest/fondo4.webp"
          alt=""
              ...
              <div className="w-full lg:w-[97%] h-full lg:h-[97%] rounded-[50px]">
                ...
                >
                  <div className="w-full h-full  overflow-auto ">
                    <img
                      src="/assets/images/portafolio/community_manager/new_fest/pc_desplegable.webp"
                      alt="Screen Capture"
                      className="w-full object-cover "
                    />
                  </div>
      ...
      <div className="w-full h-[140px]  lg:h-[300px] flex flex-col justify-center items-center text-gray-300 relative cursor-pointer degraded_main z-1">
        ...
        <img
          src="/assets/images/portafolio/capacitaciones/centro_medico_oftalmologico/foot.webp"
          alt=""
