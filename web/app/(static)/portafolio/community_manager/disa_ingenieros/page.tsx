  ...
  return (
    <section className="relative z-10  bannerMain degraded_main font_Archivo">
      ...
      <div className="h-auto w-full relative">
        <img
          src="/assets/images/portafolio/community_manager/disa_ingenieros/fondo.webp"
          alt=""
        ...
        <div className="pt-[9vh] relative overflow-hidden lg:pt-[10vh] lg:h-fit p-4 lg:pb-0 lg:px-20 xl:px-28 2xl:px-36 ">
          ...
          <div className="w-full py-[3vh] lg:py-[6vh]">
            <ImageLogo image="community_manager/disa_ingenieros/logo.webp" />
          </div>
          <Subtitle texto="Expertos en HVAC para tu Comodidad" />
        </div>
      </div>
      ...
      <div className="w-full lg:h-fit xl:h-auto relative bg-[#E1FFF3] overflow-hidden ">
        <ImageMarca />
        <img
          src="/assets/images/portafolio/community_manager/disa_ingenieros/fondo5.webp"
          alt=""
        ...
        <div className="w-full h-full relative">
          ...
          <div className="w-full h-auto relative lg:py-10 xl:py-24 px-4 flex-col lg:flex-row lg:px-10 flex gap-10 max-w-[2000px] mx-auto">
                  ...
                  <div className="w-[97%] h-[97%] rounded-[50px]">
                    <div className="rounded-[50px] absolute left-0 top-0 w-full h-full pt-[39px] lg:pt-[55px] pl-[13.1px] lg:pl-[19px] pr-[66px] lg:pr-[41px] pb-[10px] lg:pb-[18px]">
                      <div className="w-full h-full rounded-bl-[29px] rounded-br-[29px] lg:rounded-bl-[34px] lg:rounded-br-[34px] overflow-auto scroll_black">
                        <img
                          src="/assets/images/portafolio/community_manager/disa_ingenieros/celular.webp"
                          alt="Screen Capture"
            ...
            <div className="flex flex-col justify-center w-full xl:w-[60%]">
              <img
                src="/assets/images/portafolio/community_manager/disa_ingenieros/recurso2.webp"
                alt=""
                className="w-full object-contain "
              />
              <div className="flex flex-wrap xl:flex-nowrap flex-row w-full justify-between gap-x-0 gap-y-3 xl:gap-10 mt-10">
                <Link
                  href="https://www.facebook.com/disaingenieros01?locale=es_LA"
                  className="w-[49%] xl:w-full flex bg-[#006DAB] py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
                ...
                <Link
                  href="https://www.instagram.com/disaingenieros/"
                ...
                <Link
                  href="https://www.tiktok.com/@disaingenieros?fbclid=IwZXh0bgNhZW0CMTAAAR0IZMiOtx8amTmlJxwtCpVCB4gxZAytxG1n1UUWVB-ue06opLXahOX4GmQ_aem_ARTemgGQ3Jr-22VNxe5W6XG4F4o6B3ShInf8gYuNRnlGsIY5dV8XVKAOC26ANZcifBgqFiRoo75FsmsagT6PG85q"
                  className="w-full flex bg-[#006DAB] py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
      ...
      <div className="w-full relative z-2 bg-[#EE923A]">
        <img
          src="/assets/images/portafolio/community_manager/disa_ingenieros/fondo3.webp"
          alt=""
        ...
        <div className="w-full flex flex-col justify-center lg:flex-row items-center gap-3 lg:gap-10 px-4 lg:px-10 z-1  max-w-[2000px] mx-auto absolute inset-0 top-0  z-[0]">
          <img
            src="/assets/images/portafolio/community_manager/disa_ingenieros/recurso3.webp"
            alt=""
          ...
          <div className="h-fit lg:h-full w-full xl:w-[30%] flex flex-col items-center justify-center text-[#001D3F] font_Archivo_bold gap-3 lg:gap-5 xl:gap-10 text-center text-base text-[1.25rem] xl:text-[1.5rem]">
            <p className="">
              DISA INGENIEROS VISUALIZA EL PROCESO DE LOS POST EN NUESTRO
              SISTEMA DESARROLLADO PARA ELLOS.
            </p>
            <p>PROCESOS COMO:</p>
      ...
      <div className="w-full relative z-2 mt-[-30%] lg:mt-[-10%]">
        <img
          src="/assets/images/portafolio/community_manager/disa_ingenieros/fondo4.webp"
          alt=""
              ...
              <div className="w-full lg:w-[97%] h-full lg:h-[97%] rounded-[50px]">
                ...
                >
                  <div className="w-full h-full  overflow-auto ">
                    <img
                      src="/assets/images/portafolio/community_manager/disa_ingenieros/pc_desplegable.webp"
                      alt="Screen Capture"
                      className="w-full object-cover "
                    />
                  </div>
      ...
      <div className="w-full h-[140px]  lg:h-[300px] flex flex-col justify-center items-center text-gray-300 relative cursor-pointer degraded_main z-1">
        <Link
          ...
          className="absolute left-0 lg:left-4 h-fit top-0 bottom-0 z-[2] my-auto text-5xl lg:text-7xl text-white hover:scale-105 transition-all cursor-pointer"
        >
          <FaCaretLeft className="text-5xl lg:text-7xl text-white hover:scale-105 transition-all cursor-pointer" />
        </Link>
        <img
          src="/assets/images/portafolio/community_manager/disa_ingenieros/foot.webp"
          alt=""
