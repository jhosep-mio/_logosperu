...
export default function sesystec () {
  return (
    <section className="relative z-10  bannerMain degraded_main font_Archivo">
      ...
      <div className="h-auto w-full relative">
        <img
          src="/assets/images/portafolio/community_manager/sesystec/fondo.webp"
          alt=""
        ...
        <div className="pt-[9vh] relative overflow-hidden lg:pt-[10vh] lg:h-fit p-4 lg:pb-0 lg:px-20 xl:px-28 2xl:px-36 ">
          ...
          <div className="w-full py-[3vh] lg:py-[6vh]">
            <ImageLogo image="community_manager/sesystec/logo.webp" />
          </div>
          <Subtitle texto="Tecnología para tu Hogar y Negocio" />
        </div>
      </div>
      ...
      <div className="w-full lg:h-fit xl:h-auto relative bg-[#E1FFF3] overflow-hidden ">
        <ImageMarca />
        <img
          src="/assets/images/portafolio/community_manager/sesystec/fondo5.webp"
          alt=""
          ...
          <div className="w-full h-auto relative lg:py-10 xl:py-24 px-4 flex-col lg:flex-row lg:px-10 flex gap-10 max-w-[2000px] mx-auto">
            ...
            <div className="flex flex-col justify-center w-full xl:w-[60%]">
              <div className="w-full relative z-[3]">
                <img
                  src="/assets/images/portafolio/community_manager/sesystec/recurso2.webp"
                  alt=""
                  className="w-full h-full object-cover absolute inset-0 z-[0]"
                />
                <div className='w-[60%] p-2 lg:p-6 m-auto'>
                    <video className="w-full h-full  object-contain z-[3] relative" controls>
                    <source
                        src="/assets/images/portafolio/community_manager/sesystec/reelsys.mp4"
                        type="video/mp4"
                    />
              ...
              <div className="flex flex-wrap xl:flex-nowrap flex-row w-full justify-between gap-x-0 gap-y-3 xl:gap-10 mt-10">
                <Link
                  href="https://www.facebook.com/Sesystec"
                  className="w-[49%] xl:w-full flex bg-[#00ADE6] py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
                ...
                <Link
                  href="https://www.instagram.com/sesystec/"
                  className=" w-[49%] xl:w-full  flex bg-[#00003A] py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
                  <FaInstagram className="text-3xl lg:text-5xl  cursor-pointer text-azul_serio p-2 rounded-full bg-white group-hover:bg-white group-hover:text-[#00B75F]  transition-colors" />
                  INSTAGRAM
                </Link>
                <Link
                  href="https://www.tiktok.com/@luispayu"
                  className="w-full flex bg-[#00ADE6] py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
      ...
      <div className="w-full relative z-2 bg-[#0022B6]">
        <img
          src="/assets/images/portafolio/community_manager/sesystec/fondo3.webp"
          alt=""
        ...
        <div className="w-full flex flex-col justify-center lg:flex-row items-center gap-3 lg:gap-10 px-4 lg:px-10 z-1  max-w-[2000px] mx-auto absolute inset-0 top-0  z-[0]">
          <img
            src="/assets/images/portafolio/community_manager/sesystec/recurso3.webp"
            alt=""
          ...
          <div className="h-fit lg:h-full w-full xl:w-[30%] flex flex-col items-center justify-center text-[#001D3F] font_Archivo_bold gap-3 lg:gap-5 xl:gap-10 text-center text-base text-[1.25rem] xl:text-[1.5rem]">
            <p className="">
              SESYSTEC VISUALIZA EL PROCESO DE LOS POST EN NUESTRO SISTEMA
              DESARROLLADO PARA ELLOS.
            </p>
            <p>PROCESOS COMO:</p>
            <p className="bg-[#0022B6] px-4 py-3 rounded-xl text-white">
      ...
      <div className="w-full relative z-2 mt-[-30%] lg:mt-[-10%]">
        <img
          src="/assets/images/portafolio/community_manager/sesystec/fondo4.webp"
          alt=""
              ...
              <div className="w-full lg:w-[97%] h-full lg:h-[97%] rounded-[50px]">
                ...
                >
                  <div className="w-full h-full  overflow-auto ">
                    <img
                      src="/assets/images/portafolio/community_manager/sesystec/pc_desplegable.webp"
                      alt="Screen Capture"
                      className="w-full object-cover "
                    />
                  </div>
      ...
      <div className="w-full h-[140px]  lg:h-[300px] flex flex-col justify-center items-center text-gray-300 relative cursor-pointer degraded_main z-1">
        ...
        <img
          src="/assets/images/portafolio/community_manager/sesystec/foot.webp"
          alt=""
