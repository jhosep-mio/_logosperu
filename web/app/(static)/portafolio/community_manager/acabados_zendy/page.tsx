  ...
  return (
    <section className="relative z-10  bannerMain degraded_main font_Archivo">
      ...
      <div className="h-auto w-full relative">
        <img
          src="/assets/images/portafolio/community_manager/acabados_zendy/fondo.webp"
          alt=""
          className="absolute inset-0 w-full h-full object-right lg:object-center object-cover z-[-1]"
        />
        <div className="pt-[9vh] overflow-hidden relative lg:pt-[10vh] lg:h-fit p-4 lg:pb-0 lg:px-20 xl:px-28 2xl:px-36 ">
          <div className="w-full flex justify-center text-white ">
            <div className="flex gap-2 items-center text-white">
              <span className="uppercase font-bold text-xl hidden lg:block lg:text-[3vh] text-white text_shadow">
                CLIENTE
              </span>
              <AiOutlineCaretRight className="text-4xl hidden lg:block text-white" />
          ...
          <div className="w-full py-[3vh] lg:py-[6vh]">
            <ImageLogo image="community_manager/acabados_zendy/logo.webp" />
          </div>
          <Subtitle texto="Soluciones Completas" />
        </div>
      </div>
      ...
      <div className="w-full lg:h-fit xl:h-auto relative bg-[#E1FFF3] overflow-hidden ">
        <ImageMarca />
        <img
          src="/assets/images/portafolio/community_manager/acabados_zendy/fondo5.webp"
          alt=""
        ...
        <div className="w-full h-full relative">
          ...
          <div className="w-full h-auto relative lg:py-10 xl:py-24 px-4 flex-col lg:flex-row lg:px-10 flex gap-10 max-w-[2000px] mx-auto">
                  ...
                  <div className="w-[97%] h-[97%] rounded-[50px]">
                    <div className="rounded-[50px] absolute left-0 top-0 w-full h-full pt-[39px] lg:pt-[55px] pl-[13.1px] lg:pl-[19px] pr-[66px] lg:pr-[41px] pb-[10px] lg:pb-[18px]">
                      <div className="w-full h-full rounded-bl-[29px] rounded-br-[29px] lg:rounded-bl-[34px] lg:rounded-br-[34px] overflow-auto scroll_black">
                        <img
                          src="/assets/images/portafolio/community_manager/acabados_zendy/celular.webp"
                          alt="Screen Capture"
            ...
            <div className="flex flex-col justify-center w-full xl:w-[60%]">
              <img
                src="/assets/images/portafolio/community_manager/acabados_zendy/recurso2.webp"
                alt=""
                className="w-full object-contain "
              />
              <div className="flex flex-wrap xl:flex-nowrap flex-row w-full justify-between gap-x-0 gap-y-3 xl:gap-10 mt-10">
                <Link
                  href="https://www.facebook.com/AcabadosZendy1?locale=es_LA"
                  className="w-[49%] xl:w-full flex bg-main py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
                ...
                <Link
                  href="https://www.instagram.com/acabadoszendy/?fbclid=IwZXh0bgNhZW0CMTAAAR2qytrNQtKhuvbdrWXzvPvOmrWUqX_8H1zR7r-bxHqxBnNrl3_QwXqSIuc_aem_ARQLcz9yZBeFqqbs_aWHX_ieM_"
                  className=" w-[49%] xl:w-full  flex bg-main py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
                ...
                <Link
                  href="https://www.tiktok.com/@acabadoszendy?fbclid=IwZXh0bgNhZW0CMTAAAR2qgWM8hGC2JdcGt3M018FXYjHPzsJ7Vm3lWRZV-YoTvqTtcdwuuTa3nwQ_aem_ARRk36_zNnjfIfaoocIvIfprDcrhDW7kzokxYpa00rAmxejKMyrBxDPkztgmLk9gvZaB7koiVDjLWW-jUsD2LTwe"
                  className="w-full flex bg-main py-2 lg:py-4 rounded-2xl items-center justify-center font_Archivo_bold gap-2 lg:gap-4 group hover:bg-[#00B75F] transition-colors text-white"
                >
      ...
      <div className="w-full relative z-2 bg-black">
        <img
          src="/assets/images/portafolio/community_manager/acabados_zendy/fondo3.webp"
          alt=""
        ...
        <div className="w-full flex flex-col justify-center lg:flex-row items-center gap-3 lg:gap-10 px-4 lg:px-10 z-1  max-w-[2000px] mx-auto absolute inset-0 top-0  z-[0]">
          <img
            src="/assets/images/portafolio/community_manager/acabados_zendy/recurso3.webp"
            alt=""
          ...
          <div className="h-fit lg:h-full w-full xl:w-[30%] flex flex-col items-center justify-center text-[#001D3F] font_Archivo_bold gap-3 lg:gap-5 xl:gap-10 text-center text-base text-[1.25rem] xl:text-[1.5rem]">
            <p className="">
              ACABADOS ZENDY VISUALIZA EL PROCESO DE LOS POST EN NUESTRO SISTEMA
              DESARROLLADO PARA ELLOS.
            </p>
            <p>PROCESOS COMO:</p>
            <p className="bg-[#006DAB] px-4 py-3 rounded-xl text-white">
      ...
      <div className="w-full relative z-2 mt-[-30%] lg:mt-[-10%]">
        <img
          src="/assets/images/portafolio/community_manager/acabados_zendy/fondo4.webp"
          alt=""
              ...
              <div className="w-full lg:w-[97%] h-full lg:h-[97%] rounded-[50px]">
                ...
                >
                  <div className="w-full h-full  overflow-auto ">
                    <img
                      src="/assets/images/portafolio/community_manager/acabados_zendy/pc_desplegable.webp"
                      alt="Screen Capture"
                      className="w-full object-cover "
                    />
                  </div>
      ...
      <div className="w-full h-[140px]  lg:h-[300px] flex flex-col justify-center items-center text-gray-300 relative cursor-pointer degraded_main z-1">
        <Link
          ...
          className="absolute left-0 lg:left-4 h-fit top-0 z-[2] bottom-0 my-auto text-5xl lg:text-7xl text-white hover:scale-105 transition-all cursor-pointer"
        >
          <FaCaretLeft className="text-5xl lg:text-7xl text-white hover:scale-105 transition-all cursor-pointer" />
        </Link>
        <img
          src="/assets/images/portafolio/community_manager/acabados_zendy/foot.webp"
          alt=""
        ...
        <Link
          href="/portafolio/community_manager/sesystec"
