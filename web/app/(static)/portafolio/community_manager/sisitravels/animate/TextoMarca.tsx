  ...
  return (
    <section className="h-full flex flex-col xl:flex-row gap-4 lg:gap-6 xl:gap-0 lg:items-center max-w-[2000px] mx-auto pt-8 pb-4 lg:py-10 2xl:py-24 px-5 md:px-16 ">
      <div className="w-full  my-auto justify-center flex flex-col lg:gap-5 overflow-hidden items-center relative">
        ...
        >
          Sisitravels es una agencia de viajes que ofrece una experiencia única
          en cada vuelo. Hemos construido una imagen divertida y confiable,
          capturando la atención de nuestros usuarios con el uso vibrante y
          atractivo del color.
        </motion.p>
      </div>
      {/* <img src="/assets/images/portafolio/community_manager/sisitravels/recurso1.webp" alt="" className='w-full lg:w-[60%] 2xl:w-full object-contain lg:pl-10'/> */}
      <div className="w-full lg:w-[60%] h-full lg:pl-10">
        ...
        >
          <SwiperSlide className="w-full h-full">
            <img
              src="/assets/images/portafolio/community_manager/sisitravels/slide1.webp"
              alt=""
          ...
          <SwiperSlide className="w-full h-full">
            <img
              src="/assets/images/portafolio/community_manager/sisitravels/slide2.webp"
              alt=""
              className="w-full h-full  object-contain "
            />
          </SwiperSlide>
          <SwiperSlide className="w-full h-full">
            <img
              src="/assets/images/portafolio/community_manager/sisitravels/slide3.webp"
              alt=""
              className="w-full h-full  object-contain "
            />
          </SwiperSlide>
          <SwiperSlide className="w-full h-full">
            <img
              src="/assets/images/portafolio/community_manager/sisitravels/slide4.webp"
              alt=""
              className="w-full h-full  object-contain "
            />
          </SwiperSlide>
