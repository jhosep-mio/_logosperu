...
export const PlanesCorporativos = () => {
  useEffect(() => {
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-4 font-medium">
                  ...
                  <span className="text-base w-full flex-1">
                    Espacio de Disco Duro <strong>(20 GB).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4 font-medium">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                ...
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Correos corporativos <strong>(Hasta 100).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Alojamiento <strong>(Solo 8 dominios).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Base de datos Mysql <strong>(Solo 8).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                ...
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Panel de control (Propiedad del cliente)
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    1 Dominio Gratis <strong>(.com).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                ...
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Manual de Configuración de Correos Corporativos{' '}
                    <strong>(POP3).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                ...
                <li className="flex items-center gap-4">
                  <span className="text-base w-full flex-1"></span>
                </li>
                <li className="flex items-center gap-4">
                  <span className="text-base w-full flex-1"></span>
                </li>
              </ul>
              <ButtonPlan plan='Plan PLUS - Corporativo'/>
            ...
            <div className="w-full border-2 bg-white border-gray-500/30 py-8 px-8 z-10 overflow-hidden rounded-3xl lg:-mr-5 plan transition-all relative group before:absolute before:w-full before:h-full before:top-0 before:left-0 before:bg-[url(/assets/images/servicios/planes/patron.webp)] before:opacity-10 before:bg-contain before:-z-10">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-4 font-medium">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Espacio de Disco Duro <strong>(60 GB).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4 font-medium">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                ...
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Correos corporativos <strong>(Ilimitado).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Alojamiento <strong>(Solo 12 dominios).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Base de datos Mysql <strong>(Hasta 12).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
              ...
              <ButtonPlan plan='Plan Corporativo - Corporativo'/>
            ...
            <div className="w-full border-2 bg-white border-gray-500/30 py-8 px-8 z-10 overflow-hidden rounded-3xl lg:-mr-5 plan transition-all relative group before:absolute before:w-full before:h-full before:top-0 before:left-0 before:bg-[url(/assets/images/servicios/planes/patron.webp)] before:opacity-10 before:bg-contain before:-z-10">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-4 font-medium">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Espacio de Disco Duro <strong>(Ilimitado).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4 font-medium">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                ...
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Alojamiento <strong>(Dominios Ilimitados).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
                  <span className="text-base w-full flex-1">
                    Base de datos Mysql <strong>(Hasta 20).</strong>
                  </span>
                </li>
                <li className="flex items-center gap-4">
                  <LuBadgeCheck size={20} className="text-base text-main" />
              ...
              <ButtonPlan plan='Plan Ultra - Corporativo'/>
