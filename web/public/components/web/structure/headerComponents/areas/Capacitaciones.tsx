...
export const Capacitaciones = ({ setShowMenu, setAreaActiva, areaActiva } : {setShowMenu: any, setAreaActiva: any, areaActiva: string}) => {
  return (
    <div className={`absolute w-full h-full top-0 ${areaActiva === 'capacitaciones' ? 'left-0' : 'left-full'} flex flex-col items-center justify-center overflow-hidden transition-all ease-out duration-500`}>
      <button
        type="button"
        onClick={() => {
        ...
        <nav>
          <ul className="flex flex-col items-center text-gris text-lg sm:text-xl md:text-2xl gap-2 sm:gap-3 font-light">
            <li className="transition-all hover:text-secondary text-secondary">
              <Link href={'/capacitaciones'}>Facebook Ads</Link>
            </li>
            <li className="transition-all hover:text-secondary ">
              <Link href={'/capacitaciones'}>Google Ads</Link>
            </li>
            <li className="transition-all hover:text-secondary ">
              <Link href={'/capacitaciones'}>Redes sociales</Link>
            </li>
            <li className="transition-all hover:text-secondary ">
              <Link href={'/capacitaciones'}>Pasarelas de pago</Link>
            </li>
